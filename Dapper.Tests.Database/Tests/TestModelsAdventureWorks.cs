...
namespace Dapper.Tests.Database
{
    ...
    public partial class Customer
    {
        ...
        [Column, Required, StringLength(128)]
    ...
    {
        [Key, Column("ProductID"), DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    ...
    public partial class ProductDescription
    {
        ...
        [Column, Required, StringLength(400)]
    ...
    public partial class ProductModelProductDescription
    {
        ...
        [Column]
        public virtual int ProductDescriptionID { get; set; }
        [Column, Required, StringLength(6)]
