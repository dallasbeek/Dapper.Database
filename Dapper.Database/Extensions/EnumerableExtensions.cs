...
namespace Dapper.Database.Extensions
{
    ...
    internal static class EnumerableExtensions
    {
        ...
        internal static dynamic SingleOrDefaultOfType<TSource>(this IEnumerable<TSource> source, string typeName) =>
            source.SingleOrDefault(item => item.GetType().Name == typeName);


        /// <summary>
        ///     Returns the only element of an <see cref="IEnumerable" /> that is a specific type or a default value if the
        ///     sequence is empty.
        /// </summary>
