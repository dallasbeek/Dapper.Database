...
namespace Dapper.Database.Extensions
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        public static async Task<IPagedEnumerable<T>> GetPageListAsync<T>(this IDbConnection connection, int page, int pageSize, string sql = null, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            var adapter = GetFormatter(connection);
            return await connection.GetPageListAsync<T>(page, pageSize, adapter, sql ?? "where 1 = 1", null, transaction, commandTimeout);
        }
        ...
        public static async Task<IPagedEnumerable<T>> GetPageListAsync<T>(this IDbConnection connection, int page, int pageSize, string sql, object parameters, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            var adapter = GetFormatter(connection);
            return await connection.GetPageListAsync<T>(page, pageSize, adapter, sql, parameters, transaction, commandTimeout);
        }
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<T1>> GetPageListAsync<T1, T2>(this IDbConnection connection, int page, int pageSize, string sql, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
            return await GetPageListAsync<T1, T2>(connection, page, pageSize, sql, null, transaction, commandTimeout);
        }
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<T1>> GetPageListAsync<T1, T2>(this IDbConnection connection, int page, int pageSize, string sql, object parameters, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
            var type = typeof(T1);
            ...
            return new PagedList<T1>(
                await connection.QueryAsync<T1, T2>(selectSql, parameters, transaction, commandTimeout: commandTimeout, splitOn: SplitOnArgument(new[] { typeof(T2) })),
                page,
                pageSize,
                await connection.CountAsync<T1>(sql, parameters, transaction, commandTimeout: commandTimeout)
            );
        }
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<T1>> GetPageListAsync<T1, T2, T3>(this IDbConnection connection, int page, int pageSize, string sql, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<T1>> GetPageListAsync<T1, T2, T3>(this IDbConnection connection, int page, int pageSize, string sql, object parameters, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
            var type = typeof(T1);
            var tinfo = TableInfoCache(type);
            var adapter = GetFormatter(connection);
            ...
            return new PagedList<T1>(
                await connection.QueryAsync<T1, T2, T3>(selectSql, parameters, transaction, commandTimeout: commandTimeout, splitOn: SplitOnArgument(new[] { typeof(T2), typeof(T3) })),
                page,
                pageSize,
                await connection.CountAsync<T1>(sql, parameters, transaction, commandTimeout: commandTimeout)
            );
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<T1>> GetPageListAsync<T1, T2, T3, T4>(this IDbConnection connection, int page, int pageSize, string sql, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<T1>> GetPageListAsync<T1, T2, T3, T4>(this IDbConnection connection, int page, int pageSize, string sql, object parameters, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
            var type = typeof(T1);
            var tinfo = TableInfoCache(type);
            var adapter = GetFormatter(connection);
            ...
            return new PagedList<T1>(
                await connection.QueryAsync<T1, T2, T3, T4>(selectSql, parameters, transaction, commandTimeout: commandTimeout, splitOn: SplitOnArgument(new[] { typeof(T2), typeof(T3), typeof(T4) })),
                page,
                pageSize,
                await connection.CountAsync<T1>(sql, parameters, transaction, commandTimeout: commandTimeout)
            );
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<TRet>> GetPageListAsync<T1, T2, TRet>(this IDbConnection connection, int page, int pageSize, Func<T1, T2, TRet> mapper, string sql, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<TRet>> GetPageListAsync<T1, T2, TRet>(this IDbConnection connection, int page, int pageSize, Func<T1, T2, TRet> mapper, string sql, object parameters, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
            var type = typeof(T1);
            var tinfo = TableInfoCache(type);
            var adapter = GetFormatter(connection);
            ...
            return new PagedList<TRet>(
                await connection.QueryAsync(selectSql, mapper, parameters, transaction, commandTimeout: commandTimeout, splitOn: SplitOnArgument(new[] { typeof(T2) })),
                page,
                pageSize,
                await connection.CountAsync<T1>(sql, parameters, transaction, commandTimeout: commandTimeout)
            );
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<TRet>> GetPageListAsync<T1, T2, T3, TRet>(this IDbConnection connection, int page, int pageSize, Func<T1, T2, T3, TRet> mapper, string sql, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<TRet>> GetPageListAsync<T1, T2, T3, TRet>(this IDbConnection connection, int page, int pageSize, Func<T1, T2, T3, TRet> mapper, string sql, object parameters, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
            var type = typeof(T1);
            var tinfo = TableInfoCache(type);
            var adapter = GetFormatter(connection);
            ...
            return new PagedList<TRet>(
                await connection.QueryAsync(selectSql, mapper, parameters, transaction, commandTimeout: commandTimeout, splitOn: SplitOnArgument(new[] { typeof(T2), typeof(T3) })),
                page,
                pageSize,
                await connection.CountAsync<T1>(sql, parameters, transaction, commandTimeout: commandTimeout)
            );
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<TRet>> GetPageListAsync<T1, T2, T3, T4, TRet>(this IDbConnection connection, int page, int pageSize, Func<T1, T2, T3, T4, TRet> mapper, string sql, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<IPagedEnumerable<TRet>> GetPageListAsync<T1, T2, T3, T4, TRet>(this IDbConnection connection, int page, int pageSize, Func<T1, T2, T3, T4, TRet> mapper, string sql, object parameters, IDbTransaction transaction = null, int? commandTimeout = null) where T1 : class where T2 : class
        {
            var type = typeof(T1);
            var tinfo = TableInfoCache(type);
            var adapter = GetFormatter(connection);
            ...
            return new PagedList<TRet>(
                await connection.QueryAsync(selectSql, mapper, parameters, transaction, commandTimeout: commandTimeout, splitOn: SplitOnArgument(new[] { typeof(T2), typeof(T3), typeof(T4) })),
                page,
                pageSize,
                await connection.CountAsync<T1>(sql, parameters, transaction, commandTimeout: commandTimeout)
            );
