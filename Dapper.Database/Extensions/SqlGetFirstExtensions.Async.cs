...
namespace Dapper.Database.Extensions
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        public static async Task<T> GetFirstAsync<T>(this IDbConnection connection, string sql = null, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            return await connection.QueryFirstOrDefaultAsync<T>(sqlHelper.Adapter.GetListQuery(sqlHelper.TableInfo, sql), null, transaction, commandTimeout: commandTimeout);
        }
        ...
        {
            var sqlHelper = new SqlQueryHelper(typeof(T), connection);
            return await connection.QueryFirstOrDefaultAsync<T>(sqlHelper.Adapter.GetListQuery(sqlHelper.TableInfo, sql), parameters, transaction, commandTimeout: commandTimeout);
        }
        ...
        {
            return (await connection.QueryAsync(sql, mapper, null, transaction, commandTimeout: commandTimeout, splitOn: splitOn ?? SplitOnArgument(new[] { typeof(T2) }))).FirstOrDefault();
        }
        ...
        {
            return (await connection.QueryAsync(sql, mapper, parameters, transaction, commandTimeout: commandTimeout, splitOn: splitOn ?? SplitOnArgument(new[] { typeof(T2) }))).FirstOrDefault();
        }
        ...
        {
            return (await connection.QueryAsync(sql, mapper, new { }, transaction, commandTimeout: commandTimeout, splitOn: splitOn ?? SplitOnArgument(new[] { typeof(T2), typeof(T3) }))).FirstOrDefault();
        }
        ...
        {
            return (await connection.QueryAsync(sql, mapper, parameters, transaction, commandTimeout: commandTimeout, splitOn: splitOn ?? SplitOnArgument(new[] { typeof(T2), typeof(T3) }))).FirstOrDefault();
        }
        ...
        {
            return (await connection.QueryAsync(sql, mapper, new { }, transaction, commandTimeout: commandTimeout, splitOn: splitOn ?? SplitOnArgument(new[] { typeof(T2), typeof(T3), typeof(T4) }))).FirstOrDefault();
        }
        ...
        {
            return (await connection.QueryAsync(sql, mapper, parameters, transaction, commandTimeout: commandTimeout, splitOn: splitOn ?? SplitOnArgument(new[] { typeof(T2), typeof(T3), typeof(T4) }))).FirstOrDefault();
        }
