...
namespace Dapper.Database.Extensions
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        public static bool Delete<T> ( this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null ) where T : class
        {
            ...
            return Delete( connection, type, entityToDelete, transaction, commandTimeout );
        }
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        private static bool Delete ( IDbConnection connection, Type type, object parameters, IDbTransaction transaction = null, int? commandTimeout = null )
        {
            var adapter = GetFormatter( connection );
