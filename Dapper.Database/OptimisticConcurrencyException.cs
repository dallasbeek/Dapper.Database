...
namespace Dapper.Database
{
    ...
    public class OptimisticConcurrencyException : DataException
    {
        ...
        private static string BuildMessage(TableInfo tableInfo)
        {
            ...
            return
                $"Conflicts were detected for instance of entity type '{tableInfo.ClassType}' on the concurrency token properties {string.Join(", ", tableInfo.ConcurrencyCheckColumns.Select(c => c.PropertyName))}.";
        }
    }
}
